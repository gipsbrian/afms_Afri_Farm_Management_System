...
<html>
 ...
 ?>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                           ...
                           <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">VIEW CHICKEN MEDICATION</h4>
                        ...
                        <div class="row">
                        <div class="col-lg-6"><a href="chicken_medication.php"><button class="btn btn-primary">Add New Chicken Medication</button></a></div><br/><br/></div>
                        <div class="row">
							<div class="col-sm-12">
   ...
   <table class="table m-0 table-colored-full table-full-pink table-hover" style="table-layout: fixed">
		...
		<?php
        $view_users_query="SELECT * from chicken_medication_tracker";//select query for viewing chicken sales.
        ...
        ?>
			...
			<tbody>
                 ...
                 ?>
                   <tr>
                    <td><?php echo $row['Date_Of_Medication']; ?></td>
					          <td><?php echo $row['Num_Of_Hens']; ?></td>
                    <td><?php echo $row['Num_Of_Cocks']; ?></td>
                    <td><?php echo $row['Type_Of_Medication']; ?></td>
