                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Discontinuing of Attendant </h4>
    ...
    if(isset($_POST['submit']))
    {
       $message = "Activity Saved In Database";
        ...
        // $query .= "";
         ...
         //$query ="INSERT INTO `attendant_activity_log` (`Date_Of_Activity`, `Time_of_Activity`, `Description_Of_Activity`, `Verified_By`,`Attendant_ID`) VALUES ('$date_activity', '$time_activity', 'activity_description', 'activity_verified', '$location')";

         $query="INSERT INTO `attendant_discontinue` (`Attendant_ID`,`Attendant_Name`, `Date_Discontinued`, `Time_Discontinued`, `Reason_Discontinued`, `Verified_discontinued`) VALUES ('$location','$name', '$date_activity', '$time_activity', '$activity_description', '$activity_verified')";

                 $result = mysqli_query($dbcon , $query);

         $query2 = "DELETE FROM `attendant_activity_log` WHERE `attendant_activity_log`.`Attendant_ID` = '$location'";
             $result2 = mysqli_query($dbcon , $query2);


         $query1 ="DELETE FROM `attendant` WHERE `attendant`.`Attendant_ID` = '$location' ";
